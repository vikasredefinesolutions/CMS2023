      ...
      <div className='mt-[10px]'>
        <div className='container mx-auto'>
          <div className='flex items-stretch flex-wrap mx-[-15px]'>
            <div className='w-full md:w-8/12 px-[15px] mb-[30px]'>
              <div className='bg-light-gray md:p-[78px] p-[15px] h-full'>
                <div className='md:mb-[70px] mb-[24px]'>
                  <img src='/ada.webp' />
                </div>
                <div className='text-[24px] sm:text-[32px] lg:text-[45px] font-semibold mb-[18px]'>
                  {__pagesText.adaCorporateGear.header}
                </div>

                <div className='text-[16px] leading-[32px] mb-[24px]'>
                ...
                <div className='font-semibold text-[20px] leading-[22px] mb-[30px]'>
                  {__pagesText.adaCorporateGear.contact_info}
                </div>

                <div className='text-[14px] font-medium mb-[22px]'>
            ...
            <div className='w-full md:w-4/12 px-[15px] mb-[30px]'>
