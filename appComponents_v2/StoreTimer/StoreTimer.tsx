    ...
    <>
      <div className='timer btn-group my-3 flex justify-center items-center'>
        <span className='text-center'>
          <span className='text-2xl font-bold bg-primary relative text-white overflow-hidden rounded-lg px-2 py-2 inline-flex justify-center w-full'>
            {days}
          </span>{' '}
          <span className='mt-2'>Days</span>
        </span>
        <span className='text-2xl font-bold text-primary px-2 text-center'>
          <span>:</span> <span>&nbsp;</span>
        </span>
        <span className='text-center'>
          <span className='text-2xl font-bold bg-primary relative text-white overflow-hidden rounded-lg px-2 py-2 inline-flex justify-center w-full'>
