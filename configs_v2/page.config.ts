...
export const _StoreDomains = {
  ...
  domain32: 'simplisafe',
  domain36: 'usaaemployeestore.parsonskelloggonline.store', // staging
  domain37: 'porsche.parsonskellogg.com',
  domain38: 'usaaonehundred.parsonskelloggonline.store',
...
export const __domain = {
  isSiteLive: false,
  localDomain: _StoreDomains.domain37,
};
