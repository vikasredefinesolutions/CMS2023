...
const ElementCarouselDisplay = ({ bannerArr }) => {
  let tmpArr = bannerArr.images.filter(image => image.visibility === undefined || image.visibility );
  ...
  return (
    tmpArr.length > 0 && !tmpArr[0].image_as_bg && tmpArr != null ? (
      ...
      >
        {tmpArr.map((image) => {
          ...
          console.log(image);
          return ( (image.visibility === undefined || image.visibility)  &&
            <div key={image} className={`relative presentation-mode cgslide-${backgroundIndex}`}>
            <div className='overflow-hidden'>
              
              {image.image_or_video == 'Image' ? (
                image.image_link && image.image_link != '' ? <a className='block' href={`${image.image_link}`}><img src={image.image_url} alt={`${image.image_alt}`} /></a>
              ...
              {
                (image.icon_image_url || image.headline || image.headline1 || image.description || image.button_text || image.button_text1)
              &&
              <div
                className={`flex ${
              ...
              >
                ...
                >
                  ...
                  {image.description_display && (
                    ...
                    <>
                      { (image.button_display1 === 'Yes' && image.button_display === 'Yes') ?
                        <>
    ...
    {  (tmpArr.length > 0 && (tmpArr[0].visibility === undefined || tmpArr[0].visibility)) && 

            <div className="relative overflow-hidden bg-fixed bg-center bg-contain bg-no-repeat flex justify-end pt-60 pb-60" style={{ backgroundImage: `url('${tmpArr[0].image_url}')`, backgroundAttachment: tmpArr[0].fixed_background ? "fixed" : "inherit" }}>
            <div className="max-w-2xl">
            {tmpArr[0].icon_image_url && (
                        <div
                          className='text-center'
                        ><img src={tmpArr[0].icon_image_url} /></div>
                      )}
            {tmpArr[0].headline1_display && (
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: sheadlineStartTag + tmpArr[0].headline + sheadlineEndTag,
                }}
              ></div>
            )}
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: sheadline1StartTag + tmpArr[0].headline1 + sheadline1EndTag,
                  }}
                ></div>
              )}
              ...
              { tmpArr[0].button_display1 === undefined ?
                  ...
                  <>
                    { (tmpArr[0].button_display1 === 'Yes' && tmpArr[0].button_display === 'Yes') ?
                      <>
                          <div className='pt-3 lg:pt-5 text-center'>
                                <a
                                    href={image.button_link}
                          ...
                          <>
                            ...
                            >
                              <a
                                ...
                                style={{ boxShadow: tmpArr[0]?.button_box_shadow1 }}
                                rel='noreferrer'
                              >
