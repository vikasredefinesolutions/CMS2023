        ...
        <div className="w-4/4 lg:w-4/5">
          <div className="bg-[#ffffff]">
            <div className="overflow-auto max-h-screen border border-gray-border">
              ...
              <tbody>
                <tr>
                  <th className="bg-[#f5f5f6] text-center p-[16px] border-r border-gray-border">{__pagesText.ManageLogo.Logo}</th>
                  <th className="bg-[#f5f5f6] text-center p-[16px] border-r border-gray-border">{__pagesText.ManageLogo.LogoName}</th>
                  <th className="bg-[#f5f5f6] text-center p-[16px] border-r border-gray-border">{__pagesText.ManageLogo.LogoNumber}</th>
                  <th className="bg-[#f5f5f6] text-center p-[16px] border-r border-gray-border">{__pagesText.ManageLogo.ProductType}</th>
                  <th className="bg-[#f5f5f6] text-center p-[16px] border-r border-gray-border">{__pagesText.ManageLogo.LogoPosition}</th>
                </tr>
                {logoList &&
                  logoList.items.map((logo) => (
                    <tr key={logo.logo} className="text-center">
                      ...
                      <td className="border-b border-r border-gray-border p-[16px]">
                        <div className=''>{logo.logoNumber ? logo.logoNumber : 'Pending'}</div>
                      </td>
                      <td className="border-b border-r border-gray-border p-[16px]">
