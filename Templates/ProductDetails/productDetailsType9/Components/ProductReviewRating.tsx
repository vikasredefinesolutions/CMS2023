...
const ProductReviewRating: React.FC<_ProductReviewRatingProps> = ({
  ratings,
}) => {
    ...
    <>
      <div className='lg:col-span-4'>
        <h2 className='text-2xl font-bold tracking-tight text-gray-900'>
          {__pagesText.productInfo.productReviewRating.customerReview}
        </h2>
        <div className='mt-3 flex items-center'>
          <div>
            ...
            <p className='sr-only'>
              ...
              {__pagesText.productInfo.productRecentlyViewed.outOf5Starts}
            </p>
          </div>
          <p className='ml-2 text-sm text-gray-900'>
            Based on {ratings?.totalRatingCount} reviews
          </p>
        </div>
        ...
        <div className='mt-10'>
          <h3 className='text-lg font-medium text-gray-900'>
            {__pagesText.productInfo.productReviewRating.shareYourThought}
          </h3>
          <p className='mt-1 text-sm text-gray-600'>
            {
              __pagesText.productInfo.productReviewRating
