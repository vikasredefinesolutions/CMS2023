...
import { _ProductReviewDetailsProps } from '@templates/ProductDetails/productDetailsType9/Components/productDetailsComponents';
    ...
    <>
      <div className='mt-16 lg:col-span-7 lg:col-start-6 lg:mt-0'>
        <h3 className='sr-only'>
          {__pagesText.productInfo.productRecentlyViewed.recentlyReviews}
        </h3>
                  ...
                  <div className='flex items-center'>
                    <div className=''>
                      ...
                      <p className='sr-only'>
                        {reviewsDeatil.rating}{' '}
                        {
                          __pagesText.productInfo.productRecentlyViewed
                            .outOf5Starts
                        }
                      </p>
