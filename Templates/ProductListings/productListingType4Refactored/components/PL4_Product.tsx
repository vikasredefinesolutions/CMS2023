...
const PL4_Product: React.FC<_Props> = ({ product }) => {
        ...
        <div className='relative w-full mb-[20px]'>
          ...
          <div className='mt-[20px] relative px-[15px]'>
            ...
            <div className='form-group mb-[12px] text-small-text'>
              <label className='checkbox-inline align-top cursor-pointer'>
                <input
                  ...
                  type='checkbox'
                  className='w-4 h-4 mr-1 align-bottom cursor-pointer'
                />{' '}
                {
                  <>
                    {skuList.length &&
