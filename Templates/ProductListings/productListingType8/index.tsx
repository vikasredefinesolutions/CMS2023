...
import TemplateEightFilterBar from './components/TemplateEightFilterBar';
import TemplateEightListing from './components/TemplateEightListing';

const ProductListingType8: React.FC<_ListingProps> = ({
  slug,
  filters,
  products,
  CMS,
...
export default ProductListingType8;
