...
const PL9_OtherColors: React.FC<_Props> = ({
  product,
  currentProduct,
  setMainImageUrl,
  setCurrentProduct,
      ...
      product?.splitproductList?.length > 0 ? (
        <>
          <Link key={product.id} href={`/${product.sename}.html`}>
            <li
              className={`w-[28px] h-[28px] border-2 border-secondary hover:border-primary cursor-pointer`}
            >
              <NxtImage
...
export default PL9_OtherColors;
