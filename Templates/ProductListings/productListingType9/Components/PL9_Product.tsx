...
import PL9_ProductBoxController from './PL9_ProductController';
const WishlistBtn = dynamic(() => import('@appComponents/ui/Wishlist'), {
  ssr: false,
});
const PL9_OtherColors = dynamic(() => import('./PL9_OtherColors'), {
  ssr: false,
});
...
const PL9_Product: React.FC<_Props> = ({ product, pageId, seType }) => {
