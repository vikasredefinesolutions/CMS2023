...
import BrandImage from '@header/header_Type5/Components/Menu/Header_BrandImage';
      ...
      <Link href={url}>
        <>
          ...
          {focus && (
            ...
            >
              <div className='relative max-w-[900px] mx-auto p-[0px]'>
                <div className=''>
                  {content && content.length > 0 && (
                    <div className='flex flex-wrap pt-[15px] pb-[15px] border-b border-b-default mb-[15px]'>
                      {content
                        ?.filter(
                          (brand) =>
