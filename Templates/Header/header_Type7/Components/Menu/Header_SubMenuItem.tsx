    ...
    if (view === 'DESKTOP') {
      return (
        <li className=''>
          ...
          <Link href={`/${itemUrl}`}>
            <a
              className='block text-primary font-[400] tracking-[1px] leading-[18px] uppercase hover:text-white hover:bg-secondary px-[10px] py-[7px] hover:pl-[20px] transition-all duration-700'
              title={itemLabel}
            >
              {itemLabel}
            </a>
    ...
    if (view === 'DESKTOP') {
      return (
        <li className=''>
          ...
          <Link href={`/${itemUrl}`}>
            <a
              className='block text-primary font-[400] tracking-[1px] leading-[18px] hover:text-white hover:bg-primary px-[10px] py-[7px] hover:pl-[20px] transition-all duration-700'
              title={itemLabel}
            >
              {itemLabel}
            </a>
