...
const LowerHeader: React.FC<_props> = (headerContent) => {
  ...
  return (
    <>
      ...
      {storeCode === 'PKHG' ? <>
          <div style={{top: '128px'}} className={`absolute w-full`}>
            {!rightContent ? <div style={{ backgroundColor: `${headerContent.headerContent.backgroundColor}`, color: `${headerContent.headerContent.textColor}`}} className="w-full mx-auto text-center pt-[10px] pb-[10px]" dangerouslySetInnerHTML={{ __html: leftcontent}}></div> : <>
