...
export type _CO6_AddEditInputFieldsName =
  | 'firstname'
  | 'lastName'
  | 'address1'
  | 'address2'
...
export interface _CO6_AddressFields {
  firstname: string;
  lastName: string;
  address1: string;
  address2: string;
...
export const CO6_AddressFields: _CO6_AddressFields = {
  firstname: '',
  lastName: '',
  address1: '',
  address2: '',
...
export const CO6_addressValidationSchema = Yup.object({
...
export const CO6_playerInformationValdiationSchema = Yup.object({
...
export const convertIntoInitialValues = (
  cFields: _SbStoreCustomFields[] | null,
) => {
  if (!cFields) return {};
...
export interface _CO6_CreditCardFields {
  nameOnCard: string;
  ccNumber: string;
  expiryMonth: string;
  expiryYear: string;
...
export const CO6_creditCardFields: _CO6_CreditCardFields = {
  nameOnCard: '',
  ccNumber: '',
  expiryMonth: '',
  expiryYear: '',
...
export const CO6_creditCardValidationSchema = Yup.object({
...
export const CO6_purchaseOrderValidationSchema = Yup.object({
...
export const showCredidCardOption = (
  availableOption: 'bulk_payment' | 'individual_cards' | 'both',
) => {
  if (availableOption === 'both') return true;
  if (availableOption === 'individual_cards') return true;
  return false;
};

export const showPoNumberOption = (
  availableOption: 'bulk_payment' | 'individual_cards' | 'both',
) => {
  if (availableOption === 'both') return true;
  if (availableOption === 'bulk_payment') return true;
  return false;
};

export const showOrderReview = (screenToShow: _CO6_Screens) => {
  if (screenToShow === 'enterEmailAddress') return true;
...
export const showOrderBillingAndPayment = (screenToShow: _CO6_Screens) => {
  if (screenToShow === 'addPaymentMethodAndBilling') return true;
  if (screenToShow === 'completeOrderDetails') return true;
...
export const showPaymentMethodOpaque = (screenToShow: _CO6_Screens) => {
...
export const showPlayerInformation = (screenToShow: _CO6_Screens) => {
...
export const shippingFields = (address: _CO6_AddressFields) => {
  return {
