...
const SD_PhoneCountry: React.FC<_Props> = () => {
  return (
      ...
      <div className='mb-[16px]'>
        <div className='flex'>
          ...
          >
            ...
            >
              <rect x='0.5' width='14' height='12' rx='2' fill='white'></rect>
              <mask
          ...
          <div
            ...
            style={{
              ...
              margin: '0px',
              transform: 'translate3d(72.6667px, 71.3333px, 0px)',
            }}
...
export default SD_PhoneCountry;
